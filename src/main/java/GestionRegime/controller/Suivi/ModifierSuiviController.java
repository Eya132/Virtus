...
public class ModifierSuiviController {
    ...
    @FXML
    private TextField dateSuiviTextField;
    ...
    public void setSuiviToUpdate(Suivi suivi) {
        ...
        dateSuiviTextField.setText(suivi.getDate_suivi().format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss")));
    }
    ...
    public void modifierSuiviAction(ActionEvent event) {
        ...
        if (poidsTextField.getText().isEmpty() || tourDeTailleTextField.getText().isEmpty() ||
                imcTextField.getText().isEmpty() || dateSuiviTextField.getText().isEmpty()) {
        ...
        try {
            ...
            LocalDateTime dateSuivi = LocalDateTime.parse(dateSuiviTextField.getText(),
            ...
            System.out.println("❌ Erreur: Format de date invalide. Utilisez le format yyyy-MM-dd HH:mm:ss.");
        } catch (Exception e) {
